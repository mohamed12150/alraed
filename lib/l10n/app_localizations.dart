...
abstract class AppLocalizations {
  ...
  /// No description provided for @aboutMeatly.
  ///
  /// In en, this message translates to:
  /// **'Learn more about Meatly'**
  String get aboutMeatly;
  ...
  /// No description provided for @cuttingMethods.
  ///
  /// In en, this message translates to:
  /// **'Cutting Methods'**
  String get cuttingMethods;

  /// No description provided for @selectCuttingMethod.
  ///
  /// In en, this message translates to:
  /// **'Select Cutting Method'**
  String get selectCuttingMethod;
  ...
  /// No description provided for @selectPackaging.
  ///
  /// In en, this message translates to:
  /// **'Select Packaging Type'**
  String get selectPackaging;

  /// No description provided for @withFat.
  ///
  /// In en, this message translates to:
  /// **'With Fat'**
  String get withFat;
  ...
  /// No description provided for @meatOrigin.
  ///
  /// In en, this message translates to:
  /// **'Meat Origin'**
  String get meatOrigin;

  /// No description provided for @freshDaily.
  ///
  /// In en, this message translates to:
  /// **'Fresh Daily'**
