-- Update Menu: Camel, Veal, Sheep (Replacing old data)
-- تحديث القائمة: حاشي، عجل، أغنام (استبدال البيانات القديمة)

-- 1. Clean up existing data (Optional: remove if you want to keep old data)
TRUNCATE TABLE public.products CASCADE;
DELETE FROM public.categories WHERE id IN ('bbq_boxes', 'occasions', 'kilo_selections', 'feast', 'quick_picnic');
